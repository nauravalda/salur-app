...
const FoodCategoryList: React.FC = () => {
  const categoryItems = [
    { title: "Makanan Berat", imageSource: require("../assets/images/mb.png") },
    { title: "Roti dan Kue", imageSource: require("../assets/images/cake.png") },
    { title: "Makanan Vegan", imageSource: require("../assets/images/vegan.png") },
